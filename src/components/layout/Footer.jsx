          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-white flex items-center justify-center">
                <svg className="w-4 h-4 text-[#5A6C7D]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
              </div>
              <span className="font-semibold">Kremna Company</span>
            </div>
        ...
        <div className="border-t border-gray-600 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="space-y-2 text-sm">
              <p>Designed with love, built with care.</p>
              <p>
                <a href="#" className="hover:text-[#4ECDC4] transition-colors">Contact Us</a>
                {' '}- Need assistance? Our team is ready to help.
              </p>
              <p>
                <a href="#" className="hover:text-[#4ECDC4] transition-colors">About Kremna Company</a>
              </p>
            </div>
